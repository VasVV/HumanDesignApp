...
export default class PaymentOptionsEmpresa extends Component {
    constructor() {
        super();
        this.state = {
    ...
    render() {
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card mb-5 mb-lg-0">
                                 <div class="card-body">
                                    <h5 class="card-title text-muted text-uppercase text-center">Empoderamiento Basico</h5>
      ...
      <div class="col">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">Empoderamiento Completo</h5>
      ...
      <div class="col">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">Relaciones Empresariales</h5>
            <h6 class="card-price text-center">A consultar</h6>
            <hr />
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span><strong>5 Users</strong></li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>50GB Storage</li>
