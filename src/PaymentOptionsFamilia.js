...
export default class PaymentOptionsFamilia extends Component {
    constructor() {
        super();
        this.state = {
            ...
            <section class="pricing py-5">
                ...
                <Form>
                    <Form.Group controlId="ControlSelect1">
                        <Form.Label className='form-label'>Elige el numero de miembros de la familia</Form.Label>
                        ...
                        <div class="col">
                            <div class="card mb-5 mb-lg-0">
                                 <div class="card-body">
                                    ...
                                    {this.state.errorcolone && <h4 className='errorMessage'>Elige el numbero de miembros de la familia primero, por favor</h4>}
                                   
                                        <Button className="btn btn-block btn-primary text-uppercase" onClick={this.openModalOne}>Button</Button>
      ...
      <div class="col">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            {this.state.errorcoltwo && <h4 className='errorMessage'>Elige el numbero de miembros de la familia primero, por favor</h4>}
            <Button className="btn btn-block btn-primary text-uppercase" onClick={this.openModalTwo}>Button</Button>
          </div>
        </div>
      </div>
    </div>
