...
export class Dashboard extends React.Component {
    ...
    render() {
      ...
      {this.state.userdata.firstName ? <ReactSVG ref={this.svgRef} id='bodygrap3h' src={process.env.PUBLIC_URL + `/${this.state.userdata.firstName}${this.state.userdata.lastName}.svg`} /> : ''}
