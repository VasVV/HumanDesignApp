...
export class Dashboard extends React.Component {
    ...
    render() {
      ...
      {this.state.userdata.firstName ? <ReactSVG ref={this.svgRef} id='bodygrap3h' src={require(`../src/img/bodygraphs/${this.state.userdata.firstName}${this.state.userdata.lastName}.svg`).default} /> : ''}
